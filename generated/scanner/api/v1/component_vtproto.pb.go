...
func (this *Components) EqualVT(that *Components) bool {
	...
	for i := range this.OsComponents {
		if !this.OsComponents[i].EqualVT(that.OsComponents[i]) {
			return false
		}
	}
	...
	for i := range this.RhelComponents {
		if !this.RhelComponents[i].EqualVT(that.RhelComponents[i]) {
			return false
		}
	}
	...
	for i := range this.LanguageComponents {
		if !this.LanguageComponents[i].EqualVT(that.LanguageComponents[i]) {
			return false
		}
	}
...
func (this *OSComponent) EqualVT(that *OSComponent) bool {
	...
	for i := range this.Executables {
		if !this.Executables[i].EqualVT(that.Executables[i]) {
			return false
		}
	}
	return string(this.unknownFields) == string(that.unknownFields)
...
func (this *RHELComponent) EqualVT(that *RHELComponent) bool {
	...
	for i := range this.Cpes {
		if this.Cpes[i] != that.Cpes[i] {
			return false
		}
	}
	if this.AddedBy != that.AddedBy {
...
func (this *LanguageComponent) EqualVT(that *LanguageComponent) bool {
	...
	if this.Language == nil && that.Language != nil {
		...
		if !this.GetJava().EqualVT(that.GetJava()) {
			return false
		}
		if !this.GetPython().EqualVT(that.GetPython()) {
			return false
		}
	}
...
func (this *JavaComponent) EqualVT(that *JavaComponent) bool {
	...
	for i := range this.Origins {
		if this.Origins[i] != that.Origins[i] {
			return false
		}
	}
