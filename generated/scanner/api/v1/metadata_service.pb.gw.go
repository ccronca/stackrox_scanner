...
func RegisterVulnDefsServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server VulnDefsServiceServer) error {
	...
	mux.Handle("GET", pattern_VulnDefsService_GetVulnDefsMetadata_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/scannerV1.VulnDefsService/GetVulnDefsMetadata", runtime.WithHTTPPathPattern("/v1/vulndefs/metadata"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_VulnDefsService_GetVulnDefsMetadata_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_VulnDefsService_GetVulnDefsMetadata_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterVulnDefsServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client VulnDefsServiceClient) error {
	...
	mux.Handle("GET", pattern_VulnDefsService_GetVulnDefsMetadata_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/scannerV1.VulnDefsService/GetVulnDefsMetadata", runtime.WithHTTPPathPattern("/v1/vulndefs/metadata"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_VulnDefsService_GetVulnDefsMetadata_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_VulnDefsService_GetVulnDefsMetadata_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "vulndefs", "metadata"}, ""))
)
