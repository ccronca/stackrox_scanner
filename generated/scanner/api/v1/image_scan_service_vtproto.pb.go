...
func (this *GetLanguageLevelComponentsResponse) EqualVT(that *GetLanguageLevelComponentsResponse) bool {
	...
	for i := range this.LayerToComponents {
		if !this.LayerToComponents[i].EqualVT(that.LayerToComponents[i]) {
			return false
		}
	}
	if this.ScannerVersion != that.ScannerVersion {
...
func (this *LanguageLevelComponents) EqualVT(that *LanguageLevelComponents) bool {
	...
	for i := range this.Components {
		if !this.Components[i].EqualVT(that.Components[i]) {
			return false
		}
	}
	return string(this.unknownFields) == string(that.unknownFields)
