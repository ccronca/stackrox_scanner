...
func (this *GetNodeVulnerabilitiesResponse) EqualVT(that *GetNodeVulnerabilitiesResponse) bool {
	...
	for i := range this.KernelVulnerabilities {
		if !this.KernelVulnerabilities[i].EqualVT(that.KernelVulnerabilities[i]) {
			return false
		}
	}
	...
	for i := range this.KubeletVulnerabilities {
		if !this.KubeletVulnerabilities[i].EqualVT(that.KubeletVulnerabilities[i]) {
			return false
		}
	}
	...
	for i := range this.KubeproxyVulnerabilities {
		if !this.KubeproxyVulnerabilities[i].EqualVT(that.KubeproxyVulnerabilities[i]) {
			return false
		}
	}
	...
	for i := range this.RuntimeVulnerabilities {
		if !this.RuntimeVulnerabilities[i].EqualVT(that.RuntimeVulnerabilities[i]) {
			return false
		}
	}
